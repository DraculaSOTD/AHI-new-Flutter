...
abstract class RppgCommonPlatform extends PlatformInterface {
  ...
  /// Exception destroyCamera()
  Future<void> destroyCamera() =>
      throw UnimplementedError('destroyCamera() has not been implemented.');

  /// Exception resetForNewScan()
  Future<void> resetForNewScan() =>
      throw UnimplementedError('resetForNewScan() has not been implemented.');
}
